// ═══════════════════════════════════════════════════════════════
// HWASA K-Beauty ERP — Init.gs
// 초기 데이터 삽입 함수 — Apps Script 편집기에서 한 번만 실행
// ═══════════════════════════════════════════════════════════════

function initializeAll() {
  Logger.log('=== HWASA K-Beauty ERP 초기화 시작 ===');
  _initMaster();
  _initCustomers();
  _initContracts();
  _initSalarySamples();
...
function _initMaster() {
  ...
  _writeJson('m_memberGrades', ['','CLUB','BRONZE','SILVER','GOLD','VIP','VVIP','이밴트','무제한']);

  _writeJson('m_expenseItems', [
    { id:'ex01', name:'빨래',   active:true }, { id:'ex02', name:'택배',   active:true },
    { id:'ex03', name:'직원팁', active:true }, { id:'ex04', name:'쿠폰',   active:true },
    { id:'ex05', name:'마트',   active:true }, { id:'ex06', name:'청소',   active:true },
    { id:'ex07', name:'소모품', active:true }, { id:'ex08', name:'기타',   active:true },
  ]);

  _writeJson('m_purchaseCats', [
    { id:'pc01', name:'원재료', active:true }, { id:'pc02', name:'소모품', active:true },
    { id:'pc03', name:'장비',   active:true }, { id:'pc04', name:'기타',   active:true },
  ]);

  _writeJson('m_suppliers', [
    { id:'sp01', name:'화장품 도매',   contact:'', active:true },
    { id:'sp02', name:'포장재 업체',   contact:'', active:true },
    { id:'sp03', name:'의료기기 대리점', contact:'', active:true },
    { id:'sp04', name:'약품 도매',     contact:'', active:true },
  ]);

  Logger.log('마스터 데이터 초기화 완료');
}

function _initCustomers() {
  _writeJson('customers', [
    { id:'C001', name:'김민준', nameEn:'', phone:'0912-345-6789', gender:'남', birth:'1994-05-12',
      grade:'GOLD', firstVisit:'2025-08-15', area:'미딩', memo:'탈모 관심', mileage:125000,
      payments:[
    ...
    { id:'C002', name:'Nguyễn Mai', nameEn:'Nguyen Mai', phone:'0987-654-3210', gender:'여',
      birth:'1990-11-03', grade:'VIP', firstVisit:'2025-06-01', area:'꺼우저이',
      memo:'정기 관리 고객', mileage:350000,
      payments:[
    ...
    { id:'C003', name:'박서연', nameEn:'', phone:'0968-111-2222', gender:'여',
      birth:'1988-02-28', grade:'CLUB', firstVisit:'2026-01-10', area:'동다', memo:'', mileage:55000,
      payments:[
    ...
    { id:'C004', name:'Trần Hùng', nameEn:'Tran Hung', phone:'0945-333-4444', gender:'남',
      birth:'1985-07-20', grade:'', firstVisit:'2026-03-20', area:'미딩', memo:'골프 후 관리', mileage:0,
      payments:[
    ...
    { id:'C005', name:'이수진', nameEn:'', phone:'0932-555-6666', gender:'여',
      birth:'1992-09-15', grade:'BRONZE', firstVisit:'2025-11-05', area:'떠이호',
      memo:'민감성 피부 주의', mileage:88000,
      payments:[
  ...
  Logger.log('고객 데이터 초기화 완료');
}

function _initContracts() {
  _writeJson('contracts', [
  ...
  Logger.log('계약서 데이터 초기화 완료');
}

function _initSalarySamples() {
  _writeJson('salary', [
